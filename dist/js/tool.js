...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        installationCheck: function installationCheck() {
            ...
            Nova.request().get("/nova-vendor/nova-blog-tool/check-migrations").then(function (response) {
        ...
        install: function install() {
            ...
            Nova.request().get("/nova-vendor/nova-blog-tool/migrate-tables").then(function (response) {
        ...
        resetContent: function resetContent() {
            ...
            Nova.request().get("/nova-vendor/nova-blog-tool/reset-content").then(function (response) {
        ...
        deleteTables: function deleteTables() {
            ...
            Nova.request().get("/nova-vendor/nova-blog-tool/uninstall").then(function (response) {
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("heading", { staticClass: "mb-6" }, [_vm._v("Blog")]),
      _vm._v(" "),
      _c(
        "card",
        [
              ...
              _vm.installed
                ? [
                    _c("h4", { staticClass: "mb-4" }, [
                      _vm._v("Blog is currently installed and active.")
                    ]),
                    _vm._v(" "),
                    _c(
                      "button",
                ...
                : [
                    _c("p", [
                      _c("span", { staticClass: "pr-4" }, [
                        _vm._v("Blog DB tables not found.")
                      ]),
                      _vm._v(" "),
                      _c(
                        "button",
